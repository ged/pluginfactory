...
#	$Id: makedocs.rb,v 1.1 2004/03/10 06:32:57 deveiant Exp $
#
...
def makeDocs( docsdir, diagrams=false, upload=nil, ridocs=false )
	debugMsg "docsdir = %p, diagrams = %p, upload = %p, ridocs = %p" %
		[docsdir, diagrams, upload, ridocs]
...
if $0 == __FILE__
	...
	makeDocs( docsdir, diagrams, upload, rimode )
end
